...
public enum StepperStage: String, CaseIterable, Sendable {
...
public struct StepperInfo: Equatable, Sendable {
    public enum Terminal: String, Sendable { case merged, closed }
...
public enum HerdClassifier {
    ...
    public static func deriveStage(
