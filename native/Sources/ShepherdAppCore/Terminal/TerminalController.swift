...
@Observable
@MainActor
public final class TerminalController: AppExtension {
    ...
    required public init(store: SessionStore, app: AppModel) {
        self.store = store
        self.app = app
    ...
    /// was parked on.
    public func model(for sessionID: String) -> TerminalSessionModel {
