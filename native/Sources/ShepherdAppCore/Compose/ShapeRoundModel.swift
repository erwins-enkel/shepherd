...
public final class ShapeRoundModel {
    public private(set) var round: ShapeRound?
    ...
    public var visible: Bool { running || round != nil || errorKey != nil }
    public var canUseBrief: Bool {
    ...
    public func useBrief(_ answers: [RawAnswer]) async -> String? {
