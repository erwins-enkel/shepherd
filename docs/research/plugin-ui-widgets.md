...
In-repo: `src/plugins/types.ts`, `src/plugins/loader.ts`, `src/server.ts:4404`, `docs/plugins.md`; `ui/src/lib/components/settings/SettingsPluginsPanel.svelte`, `ui/src/lib/store.svelte.ts:161`, `ui/src/lib/types.ts:1131`, `ui/src/lib/api.ts:1031`, `ui/src/app.css`, `ui/src/lib/highlight.ts`. Sibling plugin: `shepherd-claude-swap/index.ts`, `shepherd-claude-swap/src/status.ts`. Related: `docs/research/claude-swap-integration.md`.
