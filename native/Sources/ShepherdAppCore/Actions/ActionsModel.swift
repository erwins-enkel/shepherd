...
@Observable
@MainActor
public final class ActionsModel: AppExtension {
    ...
    public func recordOutcomeNote(_ text: String, forSessionID sessionID: String) {
    ...
    public func consumeOutcomeNote(forSessionID sessionID: String) -> String? {
    ...
    public func actions(for session: Session) -> [SessionAction] {
