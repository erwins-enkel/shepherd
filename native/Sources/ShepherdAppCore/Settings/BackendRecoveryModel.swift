...
@Observable @MainActor public final class BackendRecoveryModel: AppExtension {
    public private(set) var diagnosticsLoading = false
    public private(set) var diagnosticsError: String?
    public private(set) var diagnostics: DiagnosticsSnapshot?
    ...
    public convenience init(store: SessionStore, app: AppModel) {
