...
export const DOCS_PAGES: readonly DocsPage[] = [
  ...
  },
  {
    ...
    path: "/operating/",
    keywords:
      "run shepherd as a systemd service, expose it over tailscale, and deploy code changes. run as a systemd user service expose it over the network deploy a code change backups & restore host tuning — tmpfs inodes host tuning — resource guardrails add a limit (one click) add a limit (copy-paste)",
  },
  {
    title: "CLI reference",
    path: "/reference/cli/",
