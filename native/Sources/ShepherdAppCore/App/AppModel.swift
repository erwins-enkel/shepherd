...
public final class AppModel {
    ...
    public private(set) var activeProfile: ServerProfile?
    ...
    public private(set) var serverMinClient: String?
    ...
    public private(set) var serverUnhealthy = false
    ...
    public var isolatedLaunchError: String?
    /// Live UI smoke may read caches but must not start server-side recomputation.
    @ObservationIgnored public let notificationEnvironment: NotificationEnvironment
    public let composerDefaults: UserDefaults
    public var liveRequestAudit: ReadOnlyRequestAudit?
    ...
    @ObservationIgnored
    public var login: @MainActor (ServerProfile, String, any CredentialStore) async throws -> Void = {
    ...
    @discardableResult
    public func addRemoteProfile(name: String, address: String) throws -> ServerProfile {
    ...
    @discardableResult
    public func addLocalProfile(port: Int = 7330) -> ServerProfile {
    ...
    public func remove(_ profile: ServerProfile) async {
    ...
    public var savedServers: [ServerProfile] { profiles.filter { $0.mode == .remote } }
    ...
    public func restoreActiveProfile() async {
    ...
    /// which clears it.
    public func signOutActiveReporting() async {
    ...
    public func reconcileSelection(against ids: [String]) {
