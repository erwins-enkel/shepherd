...
const entry = {
  ...
  // "Ack steps" button on the session row clears the gate, and you're nudged via push.
  // POST-MERGE-only steps never block. No targetId — the chip/CTA mount only when steps
