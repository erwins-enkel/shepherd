...
@Observable
@MainActor
public final class SidebarModel: AppExtension {
    ...
    public var selectedRepos: Set<String> = []
    public var collapsedStages: Set<HerdStage> = []
    ...
    public var activeRepos: Set<String> {
    ...
    public var chips: [HerdRepoChip] { HerdPartition.repoChips(store?.sessions ?? offlineSessions) }
    ...
    public func showsRepoRail(_ chips: [HerdRepoChip]) -> Bool {
    ...
    public var limits: UsageLimits? { store?.usageLimits ?? usage?.limits }
    ...
    public func toggleRepo(_ path: String, additive: Bool) {
        if additive {
    ...
    public func toggleCollapsed(_ stage: HerdStage) {
