...
public struct ModelGuidance {
    ...
    public var costBadge: String { costTier.label.uppercased() }
    public var tagBadge: String { tag.label.uppercased() }
    public var detail: String { L.t(detailKey) }

    public static func value(provider: AgentProvider, model: String) -> Self {
        switch model {
        ...
        if provider == .claude {
            ...
            case "claude-opus-5-5": return .init(costTier: .high, tag: .strong, detailKey: "model_guidance_claude_opus_5_5")
            case "claude-opus-5-5[1m]": return .init(costTier: .premium, tag: .longContext, detailKey: "model_guidance_claude_opus_5_5_1m")
    ...
    public static func optionLabel(provider: AgentProvider, model: String) -> String {
