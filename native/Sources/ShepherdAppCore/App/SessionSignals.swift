...
public enum SessionSignals {
    ...
    public static var workingBlocked: @MainActor () -> [String: Bool] = { [:] }
    ...
    public static var usageLimits: @MainActor () -> UsageLimits? = { nil }
    ...
    public static var planQuestionsUnanswered: @MainActor (String) -> Bool = { _ in false }
    ...
    /// not.
    public static var manualStepsOutstanding: @MainActor () -> [String: Int] = { [:] }
