...
## [2.0.0](https://github.com/erwins-enkel/shepherd/compare/v1.47.0...v2.0.0) (2026-09-26)
...
* **blocked:** put a judge behind the block regexes as a graded backstop ([#2378](https://github.com/erwins-enkel/shepherd/issues/2378)) ([9a9debb](https://github.com/erwins-enkel/shepherd/commit/9a9debb94566f2b6ae1036809248f77a36daab0d))
...
* **cli:** remaining verbs — PR merge, merge-train launcher, plan-gate go, halt/retry, epics ([#2512](https://github.com/erwins-enkel/shepherd/issues/2512)) ([084bd79](https://github.com/erwins-enkel/shepherd/commit/084bd795277c08190bd6bfc8bd9ccd829498fa3e))
* **cli:** settings, repo-config, diagnose verbs ([#2510](https://github.com/erwins-enkel/shepherd/issues/2510)) ([0c391e8](https://github.com/erwins-enkel/shepherd/commit/0c391e8682a1ac338087e71c629f0254f87e4f91)), closes [#2494](https://github.com/erwins-enkel/shepherd/issues/2494)
...
* **codex:** add GPT-6 Sol and Luna model choices ([#2471](https://github.com/erwins-enkel/shepherd/issues/2471)) ([d698b6f](https://github.com/erwins-enkel/shepherd/commit/d698b6f74b1dc29b0b4d295650494c537f9760ca))
...
* **codex:** redeem earned resets before automatic work stalls ([#2433](https://github.com/erwins-enkel/shepherd/issues/2433)) ([f9ac3f6](https://github.com/erwins-enkel/shepherd/commit/f9ac3f657ff6c863f14a8f261f7f3a139e3db93b))
* **config:** adopt varlock stage 1 — .env.schema + audit drift gate ([#2348](https://github.com/erwins-enkel/shepherd/issues/2348)) ([65f5843](https://github.com/erwins-enkel/shepherd/commit/65f5843410369ee56a007f765f0da57b30b5bfd0))
* **contract:** explicit-null write scalars in the swift generator ([#2412](https://github.com/erwins-enkel/shepherd/issues/2412)) ([959af4f](https://github.com/erwins-enkel/shepherd/commit/959af4fcb5fa715bc17dea6fac7761538b7c5c96))
* **contract:** merge gate, base ref and takeover confirmation for the merge request ([#2411](https://github.com/erwins-enkel/shepherd/issues/2411)) ([ea7b7ec](https://github.com/erwins-enkel/shepherd/commit/ea7b7ecf467e7774568388417ef82a75ac10ad46))
* **contract:** openapi contract and drift test for the native client ([#2349](https://github.com/erwins-enkel/shepherd/issues/2349)) ([fe403e4](https://github.com/erwins-enkel/shepherd/commit/fe403e42f0cc61c2fe32c5e83968c836b443069d))
* **contract:** per-provider usage snapshots on the usage limits ([#2407](https://github.com/erwins-enkel/shepherd/issues/2407)) ([497a0ad](https://github.com/erwins-enkel/shepherd/commit/497a0ad43ee3a89283e42fee35fadf169fd0bbb2))
...
* **demo:** seed the reachable API surface, gate the rest ([#2295](https://github.com/erwins-enkel/shepherd/issues/2295)) ([#2308](https://github.com/erwins-enkel/shepherd/issues/2308)) ([1754363](https://github.com/erwins-enkel/shepherd/commit/17543636228f78c8ea76e44e7a671ca243966cee))
* **drain:** conflict-rework agent for epic landing PRs ([#2518](https://github.com/erwins-enkel/shepherd/issues/2518)) ([68f6e9a](https://github.com/erwins-enkel/shepherd/commit/68f6e9a5d0baa5237fd2cd2ca8c8e5257360a30c))
...
* **eval:** jev backend for the stop-classifier eval — go/no-go is GO ([#2364](https://github.com/erwins-enkel/shepherd/issues/2364)) ([08b74b2](https://github.com/erwins-enkel/shepherd/commit/08b74b2645834bd505c778669df79496b584b545))
* **eval:** nightly JEV leg with real drift conditions ([#2380](https://github.com/erwins-enkel/shepherd/issues/2380)) ([095b413](https://github.com/erwins-enkel/shepherd/commit/095b4131a8860c7923be0f89f0a9f18e3d6803a1))
* **eval:** rank confidence measures by AUROC against correctness ([#2379](https://github.com/erwins-enkel/shepherd/issues/2379)) ([#2385](https://github.com/erwins-enkel/shepherd/issues/2385)) ([e860f98](https://github.com/erwins-enkel/shepherd/commit/e860f9805ba442000d9e0d572c408e92725b09c4))
...
* **gates:** gate configuration.md against .env.schema so a knob can't ship undocumented ([#2367](https://github.com/erwins-enkel/shepherd/issues/2367)) ([343d009](https://github.com/erwins-enkel/shepherd/commit/343d009db2b04c0957384e4a0d9f8a6d2cf8a8af))
...
* **herdr:** admit herdr 0.9.1 to the supported range ([#2341](https://github.com/erwins-enkel/shepherd/issues/2341)) ([35449f8](https://github.com/erwins-enkel/shepherd/commit/35449f84da19c1a2f348440a5028d7037b986aad))
...
* **judge:** route classifyStop through a decision-model seam, off by default ([#2374](https://github.com/erwins-enkel/shepherd/issues/2374)) ([5db4295](https://github.com/erwins-enkel/shepherd/commit/5db429512d7809ffdd50816cb75645eb9011160b))
* **kit:** long-running request client for slow routes ([#2417](https://github.com/erwins-enkel/shepherd/issues/2417)) ([438fcd9](https://github.com/erwins-enkel/shepherd/commit/438fcd9a7bc63a2956ee69f0d968f3e7038e257a))
* **learnings:** fail a trial the relevance judge never finds relevant ([#2384](https://github.com/erwins-enkel/shepherd/issues/2384)) ([c3d2a7e](https://github.com/erwins-enkel/shepherd/commit/c3d2a7e40fae107a7b495a640aa7c6215dfbbea5))
* **learnings:** judge house-rule relevance at spawn, off by default ([#2381](https://github.com/erwins-enkel/shepherd/issues/2381)) ([9ac2b38](https://github.com/erwins-enkel/shepherd/commit/9ac2b38be312316002dea55c82fbf4f47666c766))
* **mac:** app gate 2 — appmodel, welcome, login, main window, banner, ui smoke test ([#2373](https://github.com/erwins-enkel/shepherd/issues/2373)) ([f374df4](https://github.com/erwins-enkel/shepherd/commit/f374df4bfa493cb7f1932b6684d4bc324972b380))
* **mac:** held tasks, up next and the done panel ([#2413](https://github.com/erwins-enkel/shepherd/issues/2413)) ([69d4bb9](https://github.com/erwins-enkel/shepherd/commit/69d4bb9187ed42a540fc8df544ee41ae6970df5c))
* **mac:** new-task composer — start from an issue ([#2419](https://github.com/erwins-enkel/shepherd/issues/2419)) ([db64953](https://github.com/erwins-enkel/shepherd/commit/db64953f0e303d19ac700de532c2a89407bbe536))
* **macos:** add DMG distribution and first-launch installation ([#2441](https://github.com/erwins-enkel/shepherd/issues/2441)) ([fc081bc](https://github.com/erwins-enkel/shepherd/commit/fc081bcd4bcf587426cac42bc5058817de3fccac))
* **mac:** shepherd for mac shell foundation (gate 1) ([#2356](https://github.com/erwins-enkel/shepherd/issues/2356)) ([2ff71ae](https://github.com/erwins-enkel/shepherd/commit/2ff71ae96175917b3b8a50c33ce8d39b0308e89a))
...
* **merge:** deliberate confirmation + repo-role gate for manual merges ([#2370](https://github.com/erwins-enkel/shepherd/issues/2370)) ([1c4e041](https://github.com/erwins-enkel/shepherd/commit/1c4e041ba495c679a56d71019aa4f61b38076b17))
* **mobile:** collapse the phone bottom bar to one flat rank ([#2317](https://github.com/erwins-enkel/shepherd/issues/2317)) ([069c0f6](https://github.com/erwins-enkel/shepherd/commit/069c0f63f87c4d47e3e2db7de9ed08b64ff3ae57))
* **mobile:** open queued Codex questions with a touch button ([#2428](https://github.com/erwins-enkel/shepherd/issues/2428)) ([cb62c1a](https://github.com/erwins-enkel/shepherd/commit/cb62c1a659278808a016833587b588f6be3a3ec9))
...
* **models:** support Claude Opus 5.5 ([#2449](https://github.com/erwins-enkel/shepherd/issues/2449)) ([82f1abb](https://github.com/erwins-enkel/shepherd/commit/82f1abb7d5db1b7e57172fa95cf1ee04f871c95d))
* **namer:** include issue number in issue-spawned session names ([#2459](https://github.com/erwins-enkel/shepherd/issues/2459)) ([#2460](https://github.com/erwins-enkel/shepherd/issues/2460)) ([75b3065](https://github.com/erwins-enkel/shepherd/commit/75b3065314792a5c7edc1b3c2f85eb54733bb6e5))
* **native:** add signed automatic Mac app updates ([#2436](https://github.com/erwins-enkel/shepherd/issues/2436)) ([f104eb9](https://github.com/erwins-enkel/shepherd/commit/f104eb926cb814fe6193a933adde1a20293f0c73))
* **native:** herd lifecycle classifier ([#2408](https://github.com/erwins-enkel/shepherd/issues/2408)) ([339cf0d](https://github.com/erwins-enkel/shepherd/commit/339cf0d1e478ba8a0fe19ed710a42ae86693b147))
* **native:** herd sidebar and header parity for the mac app ([#2388](https://github.com/erwins-enkel/shepherd/issues/2388)) ([0159fef](https://github.com/erwins-enkel/shepherd/commit/0159fef75f080a6a7f3c7467239c7732f20ff7d7))
* **native:** local server supervisor for shepherd for mac ([#2387](https://github.com/erwins-enkel/shepherd/issues/2387)) ([884bd75](https://github.com/erwins-enkel/shepherd/commit/884bd75708b2a60fb6f12f0c30702f4dc080beac))
* **native:** merge automation and post-merge ([#2420](https://github.com/erwins-enkel/shepherd/issues/2420)) ([19ee6e2](https://github.com/erwins-enkel/shepherd/commit/19ee6e28352183d2f3fe2d60bcea504a189962c0))
* **native:** milestone-3 seams, manifest and harness ([#2405](https://github.com/erwins-enkel/shepherd/issues/2405)) ([d273e19](https://github.com/erwins-enkel/shepherd/commit/d273e19beff2b692ac82d25f6e5c510ee061bb44))
* **native:** plan gates, visual blocks and the two unblock actions ([#2410](https://github.com/erwins-enkel/shepherd/issues/2410)) ([3f10d8c](https://github.com/erwins-enkel/shepherd/commit/3f10d8c8fbd78f6435da52a4307e0f59410fb8fe))
* **native:** seams for parallel feature streams (s0-prep) ([#2383](https://github.com/erwins-enkel/shepherd/issues/2383)) ([0a36b01](https://github.com/erwins-enkel/shepherd/commit/0a36b016073451f6969a5c2d10495b26c22ada04))
* **native:** session action bar ([#2392](https://github.com/erwins-enkel/shepherd/issues/2392)) ([efe11fb](https://github.com/erwins-enkel/shepherd/commit/efe11fbbcf015bfd3e852242778d2b9af4d8f13e))
* **native:** session detail tabs — activity, diff, files and PR ([#2390](https://github.com/erwins-enkel/shepherd/issues/2390)) ([b9bae2f](https://github.com/erwins-enkel/shepherd/commit/b9bae2f737b3d3c9e67daa487f78032b1a06ad40))
* **native:** settings tokens and command surface ([#2427](https://github.com/erwins-enkel/shepherd/issues/2427)) ([70868fb](https://github.com/erwins-enkel/shepherd/commit/70868fb08cf6e86a2225f229e8e6f5618d0997d4))
* **native:** shepherdkit core — client, auth, events, session store ([#2360](https://github.com/erwins-enkel/shepherd/issues/2360)) ([9256508](https://github.com/erwins-enkel/shepherd/commit/9256508907d9f49f1643e52aa6715b072d501b59))
* **native:** shepherdkit package skeleton and generated client ([#2355](https://github.com/erwins-enkel/shepherd/issues/2355)) ([a4dfe49](https://github.com/erwins-enkel/shepherd/commit/a4dfe497bf68156e0b7281420029a25601b1d4cd))
* **native:** terminal stream — PTYConnection, SwiftTerm view, prompt bar ([#2389](https://github.com/erwins-enkel/shepherd/issues/2389)) ([6b127ec](https://github.com/erwins-enkel/shepherd/commit/6b127ec3467c345dac7f76f355e2c4f7e3fe6415))
* **native:** wave-1 integration — herd, plan gates and queues wired into the app ([#2418](https://github.com/erwins-enkel/shepherd/issues/2418)) ([5b88323](https://github.com/erwins-enkel/shepherd/commit/5b88323c3eaf2895a470bd3347da3745f366b03a))
* **native:** wave-2 integration — composer and merge automation wired into the app ([#2426](https://github.com/erwins-enkel/shepherd/issues/2426)) ([451b942](https://github.com/erwins-enkel/shepherd/commit/451b942668a86f3b961ee48934d2c89097ac2376))
* **native:** wave-3 integration — parity minors and deterministic kit tests ([#2429](https://github.com/erwins-enkel/shepherd/issues/2429)) ([3b2e63f](https://github.com/erwins-enkel/shepherd/commit/3b2e63f0a897daec4aab7baeaab5d93a9fda01d2))
* **native:** wire local notifications into the mac app ([#2396](https://github.com/erwins-enkel/shepherd/issues/2396)) ([2cd8462](https://github.com/erwins-enkel/shepherd/commit/2cd846283079555f8fec053771fb01cce965b591))
* **native:** wire the milestone-2 streams into the mac app ([#2391](https://github.com/erwins-enkel/shepherd/issues/2391)) ([2886cb8](https://github.com/erwins-enkel/shepherd/commit/2886cb82777386001f0840d1dae181531b0f0d33))
* **native:** wire the session action bar into the mac app ([#2394](https://github.com/erwins-enkel/shepherd/issues/2394)) ([e816e94](https://github.com/erwins-enkel/shepherd/commit/e816e94cee2b9d55a51a2f57d8f72d330585a21f))
...
* **onboarding-harness:** non-gating herdr-ceiling advisory ([#1905](https://github.com/erwins-enkel/shepherd/issues/1905)) ([#2526](https://github.com/erwins-enkel/shepherd/issues/2526)) ([463c976](https://github.com/erwins-enkel/shepherd/commit/463c976d1205e6963881e4f89d192c05fb2b2ded))
* **plan-gate:** give the plan-authoring directive a density budget ([#1947](https://github.com/erwins-enkel/shepherd/issues/1947)) ([#2307](https://github.com/erwins-enkel/shepherd/issues/2307)) ([3ab664a](https://github.com/erwins-enkel/shepherd/commit/3ab664a849f3c2369a1f12e795cc5fe002f4fe5d))
...
* sentry auto-fix — production errors → Shepherd fix PRs (Seer replacement) (epic [#2467](https://github.com/erwins-enkel/shepherd/issues/2467)) ([#2477](https://github.com/erwins-enkel/shepherd/issues/2477)) ([5c2875e](https://github.com/erwins-enkel/shepherd/commit/5c2875ed266b847c762ec70d99a13e0978850db2))
* **server:** let an access token revoke itself ([#2358](https://github.com/erwins-enkel/shepherd/issues/2358)) ([59c9034](https://github.com/erwins-enkel/shepherd/commit/59c9034e1b8c780a0565fa49a52e058ab9f72f41))
* **server:** settings patch alias for the native client ([#2422](https://github.com/erwins-enkel/shepherd/issues/2422)) ([78fd3b6](https://github.com/erwins-enkel/shepherd/commit/78fd3b676e07c6ed8058d7fb66ef1cbce7d57fda))
...
* shepherd CLI (Rust) + agent MCP read tools (epic [#2487](https://github.com/erwins-enkel/shepherd/issues/2487)) ([#2499](https://github.com/erwins-enkel/shepherd/issues/2499)) ([ce781d1](https://github.com/erwins-enkel/shepherd/commit/ce781d1cdaabea7cb9c21c60a6ccbbfdfce69f0e))
* **skills:** add shared herdr compatibility workflow ([#2340](https://github.com/erwins-enkel/shepherd/issues/2340)) ([9d7d4c3](https://github.com/erwins-enkel/shepherd/commit/9d7d4c3760af1cc5ffffd3e40e67f61f3932813b))
* **telemetry:** report send health so a silent stall is visible ([#2330](https://github.com/erwins-enkel/shepherd/issues/2330)) ([6e31500](https://github.com/erwins-enkel/shepherd/commit/6e31500264e6d0abda40958cf7e110e0c5c81bf2))
* **tokens:** read scope sees in-flight review runs ([#2423](https://github.com/erwins-enkel/shepherd/issues/2423)) ([83e8d45](https://github.com/erwins-enkel/shepherd/commit/83e8d45172fc63eff1336c12cf6d850cdbfdfcb8))
...
* **ui:** plain mode — run an agent without guards, /design pre-selects it ([#2333](https://github.com/erwins-enkel/shepherd/issues/2333)) ([d189457](https://github.com/erwins-enkel/shepherd/commit/d1894575ef426222e8553bcec52463f822356d08))
* **ui:** show Mac app downloads in the settings menu on macOS ([#2447](https://github.com/erwins-enkel/shepherd/issues/2447)) ([cc258c3](https://github.com/erwins-enkel/shepherd/commit/cc258c31fe8299de3a48fd2cef1ca464f28d7f2c))
...
* **autopilot:** re-check PR fresh before open-a-PR steer ([#2516](https://github.com/erwins-enkel/shepherd/issues/2516)) ([34fae33](https://github.com/erwins-enkel/shepherd/commit/34fae333355679a4d8234d5d263fcb40e6ec3a40))
* **autopilot:** reliable conflict nudges past stale verdicts + on git edge ([#2517](https://github.com/erwins-enkel/shepherd/issues/2517)) ([50ad31e](https://github.com/erwins-enkel/shepherd/commit/50ad31e2cf98b8dcfdd2216b8893145a56fa1727))
...
* **buildqueue:** distinguish Shepherd controls from the terminal ([#2301](https://github.com/erwins-enkel/shepherd/issues/2301)) ([0fa7346](https://github.com/erwins-enkel/shepherd/commit/0fa734660a1a58a56cd5fa6c01f9c5de3d2a31a4))
...
* **config:** reject non-numeric numeric env reads instead of using NaN ([#2365](https://github.com/erwins-enkel/shepherd/issues/2365)) ([b2bc6b0](https://github.com/erwins-enkel/shepherd/commit/b2bc6b01164cf0a88bf185f4f7d019fb53228a0c))
...
* **deps:** run node-pty perms fix on postinstall ([#2523](https://github.com/erwins-enkel/shepherd/issues/2523)) ([#2528](https://github.com/erwins-enkel/shepherd/issues/2528)) ([f05ab95](https://github.com/erwins-enkel/shepherd/commit/f05ab95fd4bc71429e996554b34fafbb35cae8da))
...
* **docs-site:** pin vercel install to a clean bun install ([#2363](https://github.com/erwins-enkel/shepherd/issues/2363)) ([81cd1e8](https://github.com/erwins-enkel/shepherd/commit/81cd1e88e8bd6736e59ec5af9db6bd9356288217))
* **eval:** keep the content that explains a mechanical failure ([#2327](https://github.com/erwins-enkel/shepherd/issues/2327)) ([6b111dc](https://github.com/erwins-enkel/shepherd/commit/6b111dcfcaf5e26f0178368b639aa6d1be798bd9)), closes [#2326](https://github.com/erwins-enkel/shepherd/issues/2326)
* **eval:** parse raw verdict before stripping a fence; re-measure baselines ([#2338](https://github.com/erwins-enkel/shepherd/issues/2338)) ([a6ae0de](https://github.com/erwins-enkel/shepherd/commit/a6ae0de0a8a083f12e7f8851a1f3fb0fccd24459))
* **eval:** point a parse-fail sample at the defect, not the boilerplate ([#2328](https://github.com/erwins-enkel/shepherd/issues/2328)) ([7008c73](https://github.com/erwins-enkel/shepherd/commit/7008c737652614711d07f6fc6cabcff675de7790))
* **eval:** re-validate the German abstain baselines under the fixed scorer ([#2368](https://github.com/erwins-enkel/shepherd/issues/2368)) ([#2372](https://github.com/erwins-enkel/shepherd/issues/2372)) ([e9740e4](https://github.com/erwins-enkel/shepherd/commit/e9740e4e5d81eb4f6d3c71ab59d153d175ce3f52))
* **eval:** run gate-commit-now at T=9 to deflake ([#2481](https://github.com/erwins-enkel/shepherd/issues/2481)) ([f494b76](https://github.com/erwins-enkel/shepherd/commit/f494b76c69b455aceb860ca075b77bf7c8ea9204))
...
* **herdr:** prune helper tabs from session.json before herdr restores ([#2031](https://github.com/erwins-enkel/shepherd/issues/2031)) ([#2525](https://github.com/erwins-enkel/shepherd/issues/2525)) ([903db3f](https://github.com/erwins-enkel/shepherd/commit/903db3f4c21116f77c1ca6a57264862beec9134d))
...
* **macos:** resume sessions directly from the ended terminal ([#2438](https://github.com/erwins-enkel/shepherd/issues/2438)) ([eeb8298](https://github.com/erwins-enkel/shepherd/commit/eeb829831edcadb6ae8e1461651bc3ad43b5d109))
...
* **maintain:** drop critic from the incident band, it counts normal rework ([#2321](https://github.com/erwins-enkel/shepherd/issues/2321)) ([d81c76f](https://github.com/erwins-enkel/shepherd/commit/d81c76f58ec734639aa2d97a35aea4456320aa28)), closes [#2319](https://github.com/erwins-enkel/shepherd/issues/2319)
* **merge-driver:** realpath isMain guard ([#2521](https://github.com/erwins-enkel/shepherd/issues/2521)) ([#2530](https://github.com/erwins-enkel/shepherd/issues/2530)) ([80964ea](https://github.com/erwins-enkel/shepherd/commit/80964eaa7bc2f0e217e412775331946e6a60110b))
...
* **native:** add Opus 5.5 to Mac picker + gate Swift model mirror ([#2509](https://github.com/erwins-enkel/shepherd/issues/2509)) ([43749d2](https://github.com/erwins-enkel/shepherd/commit/43749d277da63d181c65d8c722378a20b91adc65))
* **native:** bootstrap local backends and recover disconnected sessions ([#2437](https://github.com/erwins-enkel/shepherd/issues/2437)) ([b9c65d2](https://github.com/erwins-enkel/shepherd/commit/b9c65d237b392a2099258a510f99be65da98d466))
* **native:** catalog key for open items and success notes for resume, ready and recap ([#2401](https://github.com/erwins-enkel/shepherd/issues/2401)) ([4965c8d](https://github.com/erwins-enkel/shepherd/commit/4965c8d87aec939aba47c6b5285360586b8c277c))
* **native:** drop the duplicate prhandoff open-enum conformance ([#2414](https://github.com/erwins-enkel/shepherd/issues/2414)) ([b7168a3](https://github.com/erwins-enkel/shepherd/commit/b7168a3f85066646910096e6080461eeb850091b))
* **native:** keep the kit test suite from hanging on ci ([#2415](https://github.com/erwins-enkel/shepherd/issues/2415)) ([d9c91fe](https://github.com/erwins-enkel/shepherd/commit/d9c91fe0fb2b0008eb5ee3128e6e9437920c8dc2))
* **native:** milestone-2 follow-ups — sidebar watcher, terminal tab id, git stages ([#2395](https://github.com/erwins-enkel/shepherd/issues/2395)) ([1d5a67e](https://github.com/erwins-enkel/shepherd/commit/1d5a67e430d67f7d6a22723fbadcaec47f56b66a))
* **native:** publish updates with immutable GitHub releases ([#2439](https://github.com/erwins-enkel/shepherd/issues/2439)) ([dc9df3c](https://github.com/erwins-enkel/shepherd/commit/dc9df3c2aa42f8a198e6960b76358a99c2c5cd62))
* **native:** reconnect re-read supersedes a stale usage push in the sidebar ([#2409](https://github.com/erwins-enkel/shepherd/issues/2409)) ([cd80662](https://github.com/erwins-enkel/shepherd/commit/cd8066246ae4ad33e5dec307b2d167c900ddf463))
* **native:** session detail fits a 1440×900 window ([#2402](https://github.com/erwins-enkel/shepherd/issues/2402)) ([42acbe9](https://github.com/erwins-enkel/shepherd/commit/42acbe93b84e425b4b6d4340209b99008d753118))
* **new-task:** omit the guards block in modes that have no guards ([#2334](https://github.com/erwins-enkel/shepherd/issues/2334)) ([87a8f23](https://github.com/erwins-enkel/shepherd/commit/87a8f23822c0ac0a0ae6f69a37301c333422c9ff))
* **onboarding:** arch baseline falls back past a dead kernel.org mirror ([#2502](https://github.com/erwins-enkel/shepherd/issues/2502)) ([a61164a](https://github.com/erwins-enkel/shepherd/commit/a61164af8601d1b4653b484cb609c71f13176eb8)), closes [#2500](https://github.com/erwins-enkel/shepherd/issues/2500)
...
* **plan-gate:** trigger plan review reliably ([#2515](https://github.com/erwins-enkel/shepherd/issues/2515)) ([dc9a71a](https://github.com/erwins-enkel/shepherd/commit/dc9a71ad8f3d60927b90c2bba13819890893f77f))
* **plugins:** bundled plugins no longer render as removed ([#2480](https://github.com/erwins-enkel/shepherd/issues/2480)) ([1605e55](https://github.com/erwins-enkel/shepherd/commit/1605e55c36772ef31da508812b912582bfef7160))
...
* **sentry:** resolve bundler-relative ../ frames; substatus list query ([#2491](https://github.com/erwins-enkel/shepherd/issues/2491)) ([180d843](https://github.com/erwins-enkel/shepherd/commit/180d8431e73d02b20182bb40dd15cbf3042d4c51))
* **server:** restart a frozen event loop and name what froze it ([#2457](https://github.com/erwins-enkel/shepherd/issues/2457)) ([220a517](https://github.com/erwins-enkel/shepherd/commit/220a5170d1a5e1cee6c0ba6129b9018c9f5709e0))
* **service:** stop uniqueName spinning forever on a 32-char live name ([#2458](https://github.com/erwins-enkel/shepherd/issues/2458)) ([63a09e5](https://github.com/erwins-enkel/shepherd/commit/63a09e5ffaef4e3763d6ec1d1249199db1eadad6))
...
* **settings:** stop a stray row click from flipping consent ([#2335](https://github.com/erwins-enkel/shepherd/issues/2335)) ([b419aa1](https://github.com/erwins-enkel/shepherd/commit/b419aa19d1773dcef24ac3fa2aeb9de7b9312f77)), closes [#2331](https://github.com/erwins-enkel/shepherd/issues/2331)
* **spawn:** dialog completes on WS frame; 30s auto-detect bound is wall-clock ([#2488](https://github.com/erwins-enkel/shepherd/issues/2488)) ([f6d7756](https://github.com/erwins-enkel/shepherd/commit/f6d7756b097864702aabd14e37de097bfe4d7776))
* **tmp:** gate the tmp guard per root, stop the test suite leaking ([#2305](https://github.com/erwins-enkel/shepherd/issues/2305)) ([e4ffbc4](https://github.com/erwins-enkel/shepherd/commit/e4ffbc4d81de1eb85be5171fae5e4020059c0cdd))
* **tmp:** reclaim orphaned transient-helper mktemp cwds ([#2310](https://github.com/erwins-enkel/shepherd/issues/2310)) ([#2312](https://github.com/erwins-enkel/shepherd/issues/2312)) ([096acd4](https://github.com/erwins-enkel/shepherd/commit/096acd471d09d53ce7e5baec516857f28177a508))
* **tmp:** reclaim session + helper scratch under claude-$uid ([#2304](https://github.com/erwins-enkel/shepherd/issues/2304)) ([#2309](https://github.com/erwins-enkel/shepherd/issues/2309)) ([258ca85](https://github.com/erwins-enkel/shepherd/commit/258ca852403c5a26525bf948f5272f66ee1c5f9d))
* **ui:** avoid opening tooltips on programmatic focus ([#2455](https://github.com/erwins-enkel/shepherd/issues/2455)) ([450df58](https://github.com/erwins-enkel/shepherd/commit/450df581e1951065bc9c03d1c27843f0e98fa98e))
...
* **ui:** forward Alt+arrows to the focused terminal ([#2332](https://github.com/erwins-enkel/shepherd/issues/2332)) ([00ac1a4](https://github.com/erwins-enkel/shepherd/commit/00ac1a44d00f5e9b9209a6fb9c8ebdf3f66c9ea6))
* **ui:** keep environment tooltip off task ID actions ([#2314](https://github.com/erwins-enkel/shepherd/issues/2314)) ([8258084](https://github.com/erwins-enkel/shepherd/commit/8258084d844a5edd8fb5beed26c06d6a09d81cb1))
...
* **ui:** show a real error page instead of a bare 500 ([#2456](https://github.com/erwins-enkel/shepherd/issues/2456)) ([fd790a8](https://github.com/erwins-enkel/shepherd/commit/fd790a89cc34ac04bc855d2a6ca0fcd60667b0f5))
...
* **ui:** stop statusTip update loop freezing the page ([#2339](https://github.com/erwins-enkel/shepherd/issues/2339)) ([c30cf1c](https://github.com/erwins-enkel/shepherd/commit/c30cf1c0ed09e55f65536a3304ba4cd0401cd64a))
...
* **viewport:** stop the phone repo name overrunning the plan-gate chip ([#2320](https://github.com/erwins-enkel/shepherd/issues/2320)) ([1249b7b](https://github.com/erwins-enkel/shepherd/commit/1249b7b38fe6f7db00631f6b729e438dafb464f3))
* **worktree:** never reclaim a path another session is checked out at ([#2325](https://github.com/erwins-enkel/shepherd/issues/2325)) ([605732b](https://github.com/erwins-enkel/shepherd/commit/605732bcca3605439517087fd4452b27aff5a23e))


### Code Refactoring

* **native:** extract shared application core ([#2444](https://github.com/erwins-enkel/shepherd/issues/2444)) ([7ffff0f](https://github.com/erwins-enkel/shepherd/commit/7ffff0f6ce46a495dea73f7e27a706fdd4ca75c1))
...
* lead readmes with product benefits and native Mac app ([#2403](https://github.com/erwins-enkel/shepherd/issues/2403)) ([94acb9c](https://github.com/erwins-enkel/shepherd/commit/94acb9c25a38258442aca3e75e412f2b136df1e8))
* native macos app design spec and implementation plans ([#2350](https://github.com/erwins-enkel/shepherd/issues/2350)) ([6b6871d](https://github.com/erwins-enkel/shepherd/commit/6b6871daf666465786e89052aa23afe9a346edf3))
* native milestone-3 plans — herd classifier, plan gates, queues ([#2399](https://github.com/erwins-enkel/shepherd/issues/2399)) ([6a9df9c](https://github.com/erwins-enkel/shepherd/commit/6a9df9c0e140909a16ad92d1b4791e142546b593))
* native milestone-3 plans — merge automation and settings ([#2404](https://github.com/erwins-enkel/shepherd/issues/2404)) ([f17866d](https://github.com/erwins-enkel/shepherd/commit/f17866deb25fb15e8d3a6da002d81dbe8adf0f6a))
* native s4 actions and s6 notifications stream plans ([#2386](https://github.com/erwins-enkel/shepherd/issues/2386)) ([46744d5](https://github.com/erwins-enkel/shepherd/commit/46744d5a7f2cb9c388b93294905203a066bad13b))
* **native:** contributor quickstart for the mac app ([#2398](https://github.com/erwins-enkel/shepherd/issues/2398)) ([5277577](https://github.com/erwins-enkel/shepherd/commit/5277577744ace5d3734cfb372bad5c3f24a05ad1))
* **native:** screenshots from a live instance and an early-version note ([#2400](https://github.com/erwins-enkel/shepherd/issues/2400)) ([ce7e252](https://github.com/erwins-enkel/shepherd/commit/ce7e2521ee1286d22ee146284cc5c27e8640e6f2))
* redact absolute jev figures — MCA §2.3(f) ([#2371](https://github.com/erwins-enkel/shepherd/issues/2371)) ([235cee5](https://github.com/erwins-enkel/shepherd/commit/235cee5e6c8bc666b13e40f4ce6bb56a543be1b8))
* research — what in the JEV ecosystem is worth adopting ([#2366](https://github.com/erwins-enkel/shepherd/issues/2366)) ([34af06f](https://github.com/erwins-enkel/shepherd/commit/34af06f687331d67bb9c1da9540190bfab4dba75))
* research — what Shepherd can do with JEV ([#2343](https://github.com/erwins-enkel/shepherd/issues/2343)) ([5bf70c2](https://github.com/erwins-enkel/shepherd/commit/5bf70c28a33d32329e1440c277dd1b729621bce2))
...
* **research:** evaluate adopting varlock in Shepherd ([#2345](https://github.com/erwins-enkel/shepherd/issues/2345)) ([973d72f](https://github.com/erwins-enkel/shepherd/commit/973d72fa5bc86e081ee5de0d5de75697c7ecc2a1))
...
* sync docs to recent source changes ([#2311](https://github.com/erwins-enkel/shepherd/issues/2311)) ([19febbe](https://github.com/erwins-enkel/shepherd/commit/19febbef69523175261f610e27b7c7b8a63bf79c))
* sync docs to recent source changes ([#2318](https://github.com/erwins-enkel/shepherd/issues/2318)) ([55e01ae](https://github.com/erwins-enkel/shepherd/commit/55e01ae33985437c3f01ffd996cf7db0bbb324a6))
* sync docs to recent source changes ([#2324](https://github.com/erwins-enkel/shepherd/issues/2324)) ([47ebfa3](https://github.com/erwins-enkel/shepherd/commit/47ebfa331018b5a18a6d1bf020f43473e9b84c29))
* sync docs to recent source changes ([#2337](https://github.com/erwins-enkel/shepherd/issues/2337)) ([1733f01](https://github.com/erwins-enkel/shepherd/commit/1733f013537ea7e302f38a8e01c7b728f7e3a2be))
* sync docs to recent source changes ([#2359](https://github.com/erwins-enkel/shepherd/issues/2359)) ([4deb48d](https://github.com/erwins-enkel/shepherd/commit/4deb48da9122bb2017487553dddd105d4c3f601f))
* sync docs to recent source changes ([#2430](https://github.com/erwins-enkel/shepherd/issues/2430)) ([c4961c4](https://github.com/erwins-enkel/shepherd/commit/c4961c40ec2cdfde9c011387536d2bd0bc1f9e58))
* sync docs to recent source changes ([#2454](https://github.com/erwins-enkel/shepherd/issues/2454)) ([35eab36](https://github.com/erwins-enkel/shepherd/commit/35eab367af45df880759f2bab3b0d0fdc18b4692))
...
* **access-tokens:** mint, copy and revoke named machine tokens from the UI ([#2084](https://github.com/erwins-enkel/shepherd/issues/2084)) ([d7666e7](https://github.com/erwins-enkel/shepherd/commit/d7666e7216550a8bdea96580f9ea2b23fe3d97df))
* **access-tokens:** per-token scopes for minted access tokens ([#2089](https://github.com/erwins-enkel/shepherd/issues/2089)) ([13b475c](https://github.com/erwins-enkel/shepherd/commit/13b475c11730a650c80f61adace884f22e9b4ded)), closes [#2083](https://github.com/erwins-enkel/shepherd/issues/2083)
...
* **backlog:** show the repo emoji on Repos-overlay rows ([#2055](https://github.com/erwins-enkel/shepherd/issues/2055)) ([91bde86](https://github.com/erwins-enkel/shepherd/commit/91bde86987eec3788f96105f5750e26d5a6886f9))
* **forge:** stack-safe merge path for GitHub stacked PRs ([#2061](https://github.com/erwins-enkel/shepherd/issues/2061)) ([398bbff](https://github.com/erwins-enkel/shepherd/commit/398bbff47cb885c6db6cb0e7bb78986985e11606))
* **herdr:** admit new herdr versions via a standing SOP + herdr:compat A/B check ([#2097](https://github.com/erwins-enkel/shepherd/issues/2097)) ([4bfddc0](https://github.com/erwins-enkel/shepherd/commit/4bfddc0b8451688a8942909bbe421783d6c2503c))
* **herdr:** support herdr 0.8.0 (protocol 19) + guard the last-tab close ([#2056](https://github.com/erwins-enkel/shepherd/issues/2056)) ([92b80be](https://github.com/erwins-enkel/shepherd/commit/92b80be1ade81e60bd9036e8714b60c5ce924a8c)), closes [#2039](https://github.com/erwins-enkel/shepherd/issues/2039)
* **new-task:** show where a task waits for a human in the guards block ([#2087](https://github.com/erwins-enkel/shepherd/issues/2087)) ([c661f3c](https://github.com/erwins-enkel/shepherd/commit/c661f3c4a81c503f3ecc7564bd2e1c20e56374af))
...
* **site:** mark Shepherd as an Erwins Enkel undertaking in the footer ([#2095](https://github.com/erwins-enkel/shepherd/issues/2095)) ([9f233ff](https://github.com/erwins-enkel/shepherd/commit/9f233ff1e1e62f8a7a19ebc51943aaefc3884474))
* stack epic children onto the integration branch ([#2060](https://github.com/erwins-enkel/shepherd/issues/2060) Step 2, shape (b)) (epic [#2063](https://github.com/erwins-enkel/shepherd/issues/2063)) ([#2076](https://github.com/erwins-enkel/shepherd/issues/2076)) ([ac86330](https://github.com/erwins-enkel/shepherd/commit/ac86330c963ec43e764f0e7621858cc8320c8021))
...
* **uploads:** attach any file type, explain every blocked drop ([#2121](https://github.com/erwins-enkel/shepherd/issues/2121)) ([7d757b6](https://github.com/erwins-enkel/shepherd/commit/7d757b626eb772dc1ddf371a2a06a393beffe0f6))
...
* **diagnostics:** surface the mise/native claude duplicate and stop re-planting it ([#2115](https://github.com/erwins-enkel/shepherd/issues/2115)) ([0e96104](https://github.com/erwins-enkel/shepherd/commit/0e961046cbae4356295fbdce8c826a57f82cfd22))
...
* **forge:** don't send merge_method into a required merge queue ([#2065](https://github.com/erwins-enkel/shepherd/issues/2065)) ([91f57e8](https://github.com/erwins-enkel/shepherd/commit/91f57e8672d0142bfe690e26ff4bc42fe9da5727)), closes [#2062](https://github.com/erwins-enkel/shepherd/issues/2062)
...
* **herd:** scroll to and mark the session a global jump lands on ([#2088](https://github.com/erwins-enkel/shepherd/issues/2088)) ([6bba346](https://github.com/erwins-enkel/shepherd/commit/6bba346dafffea3a564638092e90f15cdf36b2cd))
...
* **recap:** carry recap body + blocks as sidecar files ([#2045](https://github.com/erwins-enkel/shepherd/issues/2045)) ([#2114](https://github.com/erwins-enkel/shepherd/issues/2114)) ([490ca02](https://github.com/erwins-enkel/shepherd/commit/490ca02f4e68478df7176af8f87841733550e9c7))
* **sandbox:** let mise reshim in the membrane so wrapped agents can start ([#2110](https://github.com/erwins-enkel/shepherd/issues/2110)) ([3de7d73](https://github.com/erwins-enkel/shepherd/commit/3de7d7393369bafc81bdbe4dd3849eb8a326898a))
* **sandbox:** prove the agent binary launches in the membrane ([#2111](https://github.com/erwins-enkel/shepherd/issues/2111)) ([#2120](https://github.com/erwins-enkel/shepherd/issues/2120)) ([e4d60f1](https://github.com/erwins-enkel/shepherd/commit/e4d60f1491a1435daed5fc43e5420f5cd3d0a4d0))
...
* **site:** register HRB 36940 in imprint, link imprint from docs site ([#2119](https://github.com/erwins-enkel/shepherd/issues/2119)) ([3830b70](https://github.com/erwins-enkel/shepherd/commit/3830b70e24b8d3157adf09023eb0a3d5072963ec))
...
* **spawn:** pre-trust aux worktrees so reviewers don't wedge on the trust dialog ([#2113](https://github.com/erwins-enkel/shepherd/issues/2113)) ([6d22fbe](https://github.com/erwins-enkel/shepherd/commit/6d22fbe016ef89a2dc9f3cfae96fa0d9d374212b)), closes [#2112](https://github.com/erwins-enkel/shepherd/issues/2112)
* **store:** batch schema bootstrap into one transaction ([#2093](https://github.com/erwins-enkel/shepherd/issues/2093)) ([033a6a2](https://github.com/erwins-enkel/shepherd/commit/033a6a2b5443023f3ffd173eaec1678e895e28d1))
...
* **research:** settle stacked-PR partial-merge atomicity ([#2064](https://github.com/erwins-enkel/shepherd/issues/2064)) ([46567a1](https://github.com/erwins-enkel/shepherd/commit/46567a1a470010d87f6a97aafbf5c312cd202862))
* **research:** what Shepherd could do with GitHub stacked PRs ([#2049](https://github.com/erwins-enkel/shepherd/issues/2049)) ([3430058](https://github.com/erwins-enkel/shepherd/commit/3430058edc5c2620f95f4a6326951ff6b99db1bc))
