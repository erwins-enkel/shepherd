...
public struct MergeSnapshot: Sendable {
    public var automation: [Components.Schemas.AutoMergeStatus] = []
    public var drain: [DrainStatus] = []
    public var queues: [String: BuildQueue] = [:]
    public var owed: [PostMergeSteps] = []
}
...
public final class MergeModel: AppExtension {
    ...
    public func queueState(id: String) -> MergeQueueState {
