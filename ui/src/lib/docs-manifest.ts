...
export const DOCS_PAGES: readonly DocsPage[] = [
  ...
  },
  {
    ...
    keywords:
      "every environment variable and the per-agent sandbox profiles. core live preview host tuning (tmpfs inodes) main agent terminal renderer (research preview) documentation automation (pr-gated doc agent) anonymous usage telemetry per-agent sandbox / permission profiles",
  },
  {
