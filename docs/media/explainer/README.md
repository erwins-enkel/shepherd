...
positions, semantic palette, motion and per-beat copy — the 17s loop re-timed to a
single ~23s play (~29s total with the closing thesis), each beat's window sized to its
narration line, and the beat-8 "needs you" payload held at the end.
