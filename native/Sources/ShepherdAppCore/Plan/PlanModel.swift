...
@Observable
@MainActor
public final class PlanModel: AppExtension {
    ...
    public private(set) var gates: [String: PlanGate] = [:]
    public private(set) var reviewing: Set<String> = []
    public private(set) var reviewerEnv: [String: ReviewerEnv] = [:]
    private(set) var activity: [String: [String]] = [:]
    public private(set) var openPlanTick: [String: Int] = [:]
    ...
    public private(set) var releasedGates: Set<String> = []
    ...
    public func openPlan(_ id: String) {
        guard isActive else { return }
