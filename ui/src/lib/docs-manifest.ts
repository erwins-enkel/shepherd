...
export const DOCS_PAGES: readonly DocsPage[] = [
  ...
  },
  {
    ...
    keywords:
      "read the herd, tail events and steer sessions from the terminal or an agent. install build connect and authenticate token scopes output exit codes commands read events session control work intake reviews and merge",
  },
  {
