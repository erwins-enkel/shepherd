...
struct QueuesStringsTests {
    private static let plainKeys: [StaticString] = [
        ...
        "native_held_reason_usage", "native_held_reason_capacity", "native_held_reason_unknown",
        "native_held_discard_confirm", "topbar_held_discard", "topbar_held_discard_failed", "topbar_held_discarding",
    ...
    func bothCompiledCatalogsResolveAndInterpolate(language: String) throws {
        let path = try #require(CoreResources.bundle.path(forResource: language, ofType: "lproj"))
