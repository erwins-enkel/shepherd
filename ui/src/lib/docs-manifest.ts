...
export const DOCS_PAGES: readonly DocsPage[] = [
  ...
  },
  {
    ...
    keywords:
      "the shepherd-specific and industry terms used throughout the app and these docs. shepherd concepts epic critic merge train rework inferred lightweight repo trial weighted units reasoning effort satellite pass spawn prompt industry terms pr ci telemetry",
  },
  {
