...
@Observable
@MainActor
public final class NewSessionExtras {
    ...
    public func apply(to request: inout CreateSessionRequest) {
...
public enum NewSessionSlot {
    ...
    public static var options: (@MainActor (NewSessionExtras) -> AnyView)?
