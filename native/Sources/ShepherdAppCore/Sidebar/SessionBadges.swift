...
public struct SessionBadgeMarker: Identifiable, Equatable {
...
public struct SessionBadge: Identifiable, Equatable {
    public init(id: String, text: String, tint: Color, url: URL? = nil, markers: [SessionBadgeMarker] = []) {
        self.id = id; self.text = text; self.tint = tint; self.url = url; self.markers = markers
    }
    public let id: String
    public let text: String
    public let tint: Color
    public var url: URL? = nil
    public var markers: [SessionBadgeMarker] = []
}

public enum SessionBadges {
    /// Pre-provider sessions were Claude. Compute over the entire visible list, not each group.
    public static func showsCli(for sessions: [Session]) -> Bool {
    ...
    public static func safeURL(_ candidates: String?...) -> URL? {
    ...
    public static func issue(_ session: Session, git: GitState?) -> SessionBadge? {
    ...
    public static func pr(_ git: GitState?) -> SessionBadge? {
