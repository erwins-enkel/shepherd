 ...
 *  covers the remaining duplicated dimension (the glyphs). Covers all five HerdFilter
 *  values, `all` included — both the HerdLensStrip and the CommandBar surface all five. */
