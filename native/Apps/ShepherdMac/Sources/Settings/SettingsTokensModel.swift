...
@Observable @MainActor final class SettingsTokensModel {
    ...
    @discardableResult
    func authenticate(profile: ServerProfile, password: String, activeClient: ShepherdClient? = nil,
    ...
    @discardableResult
    func mint(name: String, days: Components.Schemas.AccessTokenMintRequest.ExpiresInDaysPayload?,
    ...
    @discardableResult
    func revoke(id: String) -> Task<Void, Never>? {
