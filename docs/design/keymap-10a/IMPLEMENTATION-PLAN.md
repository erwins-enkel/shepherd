...
| 3   | `--cap-bg: #12100b`                    | `--cap-bg: color-mix(in srgb, var(--color-amber) 10%, var(--color-panel))`                                                                                                                                                                            | Shepherd hat drei Themes (dark/light/high-contrast). Ein Dark-Literal wäre im Light-Theme ein schwarzer Klotz. Der color-mix ist deckend (Voraussetzung, um den Scrim zu überschreiben), theme-korrekt und literalfrei — konform zur Hausregel „Tokens statt Literalwerte". |
...
| Datei                                                     | Änderung                                                                                                                                                                                                                         |
| --------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `ui/src/app.css`                                          | `--cap-bg` (color-mix, in allen drei Theme-Blöcken automatisch korrekt)                                                                                                                                                          |
